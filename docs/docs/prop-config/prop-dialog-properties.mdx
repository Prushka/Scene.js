...
sidebar_position: 7
description: Set dialog related properties for your prop
---
...
Global config defines prop dialog tabs' behaviors (see **[here](../global-config/global-components/prop-dialog-tabs)**).
