...
import {
    ...
    scenePropType,
    scenePropStyle,
    sceneDefaultLightColor, sceneDefaultDarkColor, scenePropColor, scenePropColorWithNameColor
} from "../../src/components/Scene/SceneComponents";

:::tip

Check [here](../global-config/theme) to see how to set a default theme
