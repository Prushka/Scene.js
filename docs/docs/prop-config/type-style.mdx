...
sidebar_position: 5
description: Set the required prop type and optional style
---

import {
    SceneOnlyShort,
    GeneratorConfigBlock, scenePropType, scenePropStyle,
} from "../../src/components/Scene/SceneComponents";

## Type (required)

To use **custom prop types**, see **[Custom Prop Types](../global-config/custom-prop-types)**
