...
title: Prop Dialog
sidebar_position: 4
description: Interact with the embedded prop dialog
---

import {
    sceneUserInteractionPropDialog,
    SceneOnly, SceneWithSelection
} from "../../src/components/Scene/SceneComponents";

<SceneWithSelection useShort={false} propSelected={'Select Me'}  {...sceneUserInteractionPropDialog}/>
